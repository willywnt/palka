...
| 7   | **Keuangan / True Net P&L** (expense ledger + net-profit report)     | finance/reporting | L      | 🟢   | **Phase 1 SHIPPED 2026-06-26** (branch `session/2026-06-26-finance-net-pl`): new `modules/finance` Expense ledger (`/dashboard/finance/expenses`) + a "Laba bersih (Net P&L)" report under Laporan (`/dashboard/reports/net-profit`) = gross profit − Σ operating expenses; `finance.view`/`finance.manage` keys (catalog now 13); additive migration. Audit big-bet #1. **Phase 2 backlog** (recurring/auto-derived fees/CSV/filter UI/budget): `docs/roadmap/finance.md`.                                                                                                                                                                                                                                                                                                       |
